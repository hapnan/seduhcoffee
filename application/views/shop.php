  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="kopi.jpg" data-color="lightblue" alt="First Image">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <img class="img-fluid" src="origin.jpg" alt="Green">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
    ...
    <section class="content2">
      <div class="row">
        <div class="col-md-12">
            <img src="footer.jpg" alt="" class="img-fluid w-100">
        </div>
      </div>
    </section>
        ...
        <div class="row ">
          <div class="alamat col-md-6 text-light">
            <div class="alamat-item">
              ...
              <br>
              <img src="instagram.png" width="30dp" height="30dp"  >
              <span>@Seduhcoffe.id</span>
              <br>
              <img src="facebook.png" width="30dp" height="30dp">
