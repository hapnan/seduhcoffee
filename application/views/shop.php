    ...
    <nav class="navbar navbar-expand-lg  navbar-light scrolling-navbar fixed-top">
        ...
        <div class="form-inline my-2 my-lg-0">
          ...
          shopping_cart
				...
				<a href="<?= base_url('register'); ?>"><button class="btn btn-outline-danger mr-1" type="button" >Register</button></a>
        <a href="<?= base_url('login'); ?>"><button class="btn btn-outline-success my-2 my-sm-0" type="button" >Login</button></a>
        </div>
    </nav>
    <!-- navbar end-->
